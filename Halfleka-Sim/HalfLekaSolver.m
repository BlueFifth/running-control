...
while tspan(1) <Sim.time %[output:group:0a16c001]
    ...
    [t, x, te, xe, ie] = ode113(@(t, X) halfleka_dynamics(t, X), tspan, X0, options); %[output:45547340]
...
sim("data_inspector_Halfleka.slx");
%%
%[text] ## Animate (drawnow)
if Animate ==1
    fps = 100; % Desired frame rate
...
%---
%[output:45547340]
%   data: {"dataType":"text","outputData":{"text":"Time = 3.6290","truncated":false}}
%---
